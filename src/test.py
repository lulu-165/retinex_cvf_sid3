...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default='../models/CVF_SID/SIDD_Val/config.json', type=str,
                      help='config file path (default: None)')
    args.add_argument('-r', '--resume', default='../models/CVF_SID/0529_203330/SIDD_Val/checkpoint-epoch63.pth', type=str,
